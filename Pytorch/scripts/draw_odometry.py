...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', default='./pre_trained/odo_M.pth', help='model save path')
    parser.add_argument('--data_path', default='../kitti_odometry', help='kitti odometry dataset path')
    parser.add_argument('--gt_dir', default='./mono/datasets/gt_pose',help='kitti odometry gt path')
    parser.add_argument('--result_dir', default='./output/odometry')
