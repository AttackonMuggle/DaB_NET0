...
from mono.model.mono_hrnet.pose_encoder import PoseEncoder
from mono.model.mono_hrnet.pose_decoder import PoseDecoder
...
if __name__ == "__main__":
    data_path ='../kitti_odometry'#path to kitti odometry
    model_path = './re_1s_zoom_diff_qkvmut2_M.pth'
    height = 320
    width = 1024
    sequence_id = 9
